...
from backend.app.config import GIGACHAT_AUTH_TOKEN
...
async def generate_description(name: str):
    response = model.chat(f"Напиши краткое и простое описание задачи: {name}. Описание должно быть понятным, без сложных терминов и длинных предложений.")
    return {
